  ...
  return (
    <div className="flex flex-wrap items-center gap-5 border-b border-line-soft bg-bg px-6 py-2.5 text-[12px] text-text-faint">
      ...
      <div className="flex gap-3.5">
        <span className="flex items-center gap-1.5"><i className="h-2 w-2 rounded-sm bg-easy" /> {easy} easy</span>
        <span className="flex items-center gap-1.5"><i className="h-2 w-2 rounded-sm bg-medium" /> {medium} medium</span>
        <span className="flex items-center gap-1.5"><i className="h-2 w-2 rounded-sm bg-hard" /> {hard} hard</span>
      </div>
    </div>
  );
}